...
import Map from "../basket/component/Map";
    ...
    <div className="home-page">
      <section class="home-mainbanner">
        ...
        <div class="home-mainbanner__container">
          <h1 class="home-mainbanner__title">ДЛЯ ДИСТРИБЬЮТЕРОВ</h1>
          <div class="home-mainbanner__subtitle"></div>
          <div class="home-mainbanner__content">
            <div class="home-contact">
              <form class="home-contact__form home-formbox__form form">
                ...
                <button
                  onClick={() => {
                    dispatch.messageSlice.sendMessageDis({
                      name,
                      message,
                      phone,
                    });
